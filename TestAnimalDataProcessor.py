...
from scraper import WikipediaAnimalScraper
...
class TestIntegration:
    ...
    @patch('scraper.WikipediaAnimalScraper._get_page')
    @patch('scraper.WikipediaAnimalScraper._get_animal_image_from_api')
