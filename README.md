...
- **HTML Format**: Allows you to search for an animal
...
4. **Output Phase**: Displays results and saves to multiple file formats
...
This project is for educational and demonstration purposes, showcasing professional Python development practices.
